...
class Startnest{
      ...
      */
      public function nest_enqueue_scripts(){
        ...
        $select_two_js = isset( $nest_theme_mod['select_two_js'] ) ? $nest_theme_mod['select_two_js'] : '';
        $productpaginaionurl = '';
        ...
        if($select_two_js == true):
          wp_enqueue_style('select2css', NEST_ADDONS_URL . 'assets/css/plugins/select2.min.css', array() , '4.07', 'all');
        endif;
       ...
       // wp_enqueue_script('bootstrap-bundle', NEST_ADDONS_URL . 'assets/js/vendor/bootstrap.bundle.min.js', array('jquery') , '5.0.0', true);
        ...
        wp_enqueue_script('select2-active', NEST_ADDONS_URL . 'assets/js/select-active.js', array('jquery') , '1.0', true);
        endif;
