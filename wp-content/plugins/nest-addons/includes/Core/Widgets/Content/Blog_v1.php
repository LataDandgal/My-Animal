    ...
    $this->add_control(
        'owl_nav_color',
         [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .blog_carousel   .owl-nav i ' => 'color: {{VALUE}}!important;',
            ],
         ]
    ); 
    ...
    $this->add_control(
        'owl_nav_bg_color',
         [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .blog_carousel  .owl-carousel .owl-nav .owl-prev  , {{WRAPPER}} .blog_carousel  .owl-carousel .owl-nav .owl-next ' => 'background: {{VALUE}}!important;',
            ],
         ]
    );
    ...
    $this->add_control(
        'owl_nav_hover_color',
         [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .blog_carousel   .owl-nav .owl-prev:hover i , {{WRAPPER}} .blog_carousel   .owl-nav .owl-next:hover i ' => 'color: {{VALUE}}!important;',
            ],
         ]
    );
    ...
    $this->add_control(
        'owl_nav_hover_bg_color',
         [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .blog_carousel  .owl-carousel .owl-nav .owl-prev:hover , {{WRAPPER}} .blog_carousel  .owl-carousel .owl-nav .owl-next:hover ' => 'background: {{VALUE}}!important;',
            ],
         ]
    );
                        ...
                        <div class="<?php echo esc_attr($settings['blog_column']); ?>">
                                ...
                                <?php if(has_post_thumbnail()): ?>
                                    ...
                                    <div class="entry-content-2 pl-50">
                                        ...
                                        <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                            ...
                                            <a href="<?php echo esc_url(get_permalink()); ?>" class="text-brand font-heading font-weight-bold"><?php echo esc_html__('Read more' , 'nest-addons'); ?> <i class="fi-rs-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            ...
                            <div class="entry-content">
                                ...
                                <div class="mb-20 entry-meta meta-2">
                                    ...
                                    <a href="<?php echo esc_url(get_permalink()); ?>" class="btn btn-sm"><?php echo esc_html__('Read More' , 'nest'); ?><i class="fi-rs-arrow-right ml-10"></i></a>
                                </div>
                                </div>
                            </article>
                            </div>  
                    ...
                    <?php // blog style ?>    
                            ...
                            <div class="entry-content">
                                ...
                                <div class="mb-20 entry-meta meta-2">
                                    ...
                                    <a href="<?php echo esc_url(get_permalink()); ?>" class="btn btn-sm"><?php echo esc_hesc_html__tml('Read More' , 'nest'); ?><i class="fi-rs-arrow-right ml-10"></i></a>
                                </div>
                                </div>
                            </article>
