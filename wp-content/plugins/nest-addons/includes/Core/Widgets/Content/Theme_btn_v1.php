...
class Theme_btn_v1 extends \Elementor\Widget_Base
{
    ...
    {
        return 'nest-themebtns-v1';
    }

    public function get_title()
    {
        return __('Theme Buttons V1' , 'nest-addons');
    }
    ...
    protected function register_controls(){   
        $this->start_controls_section(
            'theme_btn_content',
            [
                'label' => __('theme Button Content', 'nest-addons')
            ]
        );
        ...
        $this->add_control(
            'theme_btn_styles',
            [
                'label' => __('theme Button Styles', 'nest-addons'),
        ...
        $this->add_control(
			'button_text',
			[
				'label'       => esc_html__( 'Button Text', 'nest-addons' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
                'default' =>  esc_html__( 'Contact us' , 'nest-addons'),
		]);

        $this->add_control(
            'button_link',
        [
            'label' => __('Theme Link', 'nest-addons'),
        ...
        [ 
            'label' => __('Theme Button Css', 'nest-addons'),
        ...
        $this->add_control(
			'button_padding',
			[
				'label' => esc_html__( 'Button Padding', 'nest-addons' ),
        ...
        $this->add_responsive_control(
            'btn_alignments',
            [
                'label' => __('Button alignments', 'nest-addons'),
        ...
        $this->add_control(
            'button_hover_color',
             [
                'label' => __('Button Hover Color', 'nest-addons'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_hovre_bg_color',
             [
                'label' => __('Button Hover Background Color', 'nest-addons'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
