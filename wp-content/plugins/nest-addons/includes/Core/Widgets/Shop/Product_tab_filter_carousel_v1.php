    ...
    <div class="s_tabs_content tab-content">
            <?php if(!empty( $product_filter_repeater)):
                foreach($product_filter_repeater as $key => $product_value ):
                    ...
                    if (!empty($product_value['query_category']) && is_array($product_value['query_category'])) {
                        $category_string = implode(',', $product_value['query_category']);
                    ...
                    if($product_value['product_options_showing'] == 'outofstock'):
                        ...
                        elseif ($product_value['product_options_showing'] == 'price_low_high'):
                            $query_args['meta_key'] = '_price';
                            $query_args['orderby'] = 'meta_value_num';
                            $query_args['order'] = 'ASC';
                        elseif ($product_value['product_options_showing'] == 'price_high_low') :
                            $query_args['meta_key'] = '_price';
                            $query_args['orderby'] = 'meta_value_num';
