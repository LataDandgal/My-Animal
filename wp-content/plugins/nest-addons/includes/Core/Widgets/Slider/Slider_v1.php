...
class Slider_v1 extends \Elementor\Widget_Base
{
    ...
    $repeater->add_control(
      ...
      $this->add_control(
        'slider_image_type',
        [
          'label' => __( 'Slider Image Type', 'nest-addons' ),
          'type' => \Elementor\Controls_Manager::SELECT, 
          'options' => [
            'background'  => __( 'Background Type', 'nest-addons' ),
            'image'  => __( 'Image Type', 'nest-addons' ),
          ],
          'default' => 'background' ,
        ]
      );
      ...
      $this->add_responsive_control(
        ...
        [
          ...
          'toggle' => true,
          'selectors' => [
              '{{WRAPPER}} .hero-slider-1 .single-hero-slider .simage img ' => 'object-position: {{VALUE}}!important; -o-object-position:{{VALUE}}!important;',
          ],
          'condition' => [
    ...
    $this->add_responsive_control(
      ...
      $this->add_responsive_control(
          'title_color',
           [
              ...
              'type' => \Elementor\Controls_Manager::COLOR,
              'selectors' => [
                  '{{WRAPPER}} .hero-slider-1 .single-hero-slider .slider-content .display-2.mb-40' => 'color: {{VALUE}}!important;',
              ],
           ]
      );
      $this->add_responsive_control(
      ...
      $this->add_responsive_control(
          ...
          [
              ...
              'size_units' => [ 'px', '%', 'em' ],
              'selectors' => [
                  '{{WRAPPER}} .hero-slider-1 .home-slider , {{WRAPPER}} .hero-slider-1 .single-hero-slider ' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important;',
              ],
          ]
      );
      $this->end_controls_section();
    ...
    protected function render()
    {
        ...
        <section class="home-slider position-relative">
            ...
            <?php if($settings['slider_repeater']) : foreach($settings['slider_repeater'] as  $key => $slider_repeater): 
              ...
              ?>
							<div class="single-hero-slider <?php echo esc_attr($slider_repeater['content_alginment']); ?> <?php if($settings['slider_styles'] == 'style_two'): ?> rectangle <?php endif; ?>   single-animation-wrap" 
                <?php if($settings['slider_image_type'] == 'background'): ?> <?php if(!empty($slider_repeater['slider_background_image'])): ?> style="background-image: url(<?php echo esc_attr($slider_repeater['slider_background_image']['url']); ?>)" <?php endif; ?><?php endif; ?>>
                <?php if($settings['slider_image_type'] == 'image'): ?>
								<?php if(!empty($slider_repeater['slider_background_image'])): ?>
                  <div class="simage">
                    <img src="<?php echo esc_attr($slider_repeater['slider_background_image']['url']); ?>)"  class="slider_img" class="img-fluid" />
                  </div> 
                <?php endif; ?>
                <?php endif; ?>
