    ...
    protected function register_controls(){
       ...
       $this->add_control(
        ...
        $this->add_control(
            'language_type',
            [
                'label' => __('Language Type', 'nest-addons'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'custom_link'   => esc_html__( 'Custom Link', 'nest-addons' ),
                    'shortcode_lan'   => esc_html__( 'Shortcode', 'nest-addons' ), 
                ],
                'default' => 'custom_link',
                'condition' => [
                    'language_enable' => 'yes' , 
        ...
        $this->add_control(
            'shortcode_language',
            [
                'label' => __( 'Place Language Shortcode', 'nest-addons' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __( '[language-switcher]', 'nest-addons' ),
                'condition' => [
                    'language_type' => 'shortcode_lan' ,
                    'language_enable' => 'yes' ,
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'custom_link'   => esc_html__( 'Custom Link', 'nest-addons' ),
                    'shortcode_cur'   => esc_html__( 'Shortcode', 'nest-addons' ), 
                ],
                'default' => 'custom_link',
                'condition' => [
                    'currency_enable' => 'yes'
        ...
        $this->add_control(
            'shortcode_currency',
            [
                'label' => __( 'Place Currency Shortcode', 'nest-addons' ),
                'type' => \Elementor\Controls_Manager::TEXT,
        ...
        $this->add_control(
            'login_link',
            [
                'label' => __( 'Login Custom Link', 'nest-addons' ),
                'type' => \Elementor\Controls_Manager::URL,
                'placeholder' => __( 'https://your-link.com', 'nest-addons' ),
                'show_external' => true,
                'default' => [
        ...
        $this->add_control(
            ...
            're_link',
            [
                'label' => __( 'Register Custom Link', 'nest-addons' ),
                'type' => \Elementor\Controls_Manager::URL,
                'placeholder' => __( 'https://your-link.com', 'nest-addons' ),
                'show_external' => true,
                'default' => [
                        ...
                        <div class="swiper  news-flash">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="<?php echo esc_url($flash_news_repeater['news_link']['url']); ?>"
                    ...
                    <div class="header-info header-info-right">
                        <ul>
                            ...
                            <?php if($settings['language_enable'] == 'yes'): ?>
                                <?php if($settings['language_type'] == 'custom_link'): ?>
                            <li>
                                    ...
                                    <li>
                                        <a href="<?php echo esc_url($language_repeater['language_link']['url']); ?>"
                                            ...
                                            <?php if(!empty($language_repeater['language_icon_image']['url'])):
                                                 $alt_text = 'alt';
                                                 $image = isset($language_repeater['language_icon_image']['alt']) ? $language_repeater['language_icon_image']['alt'] : '';
                                                 if(!empty($image)) {
                                                     $alt_text = $image;
                                                 }
                                                ?>
                            ...
                            <?php elseif($settings['language_type'] == 'shortcode_lan'): ?>
                            <li>
                            <?php echo do_shortcode($settings['shortcode_language']); ?>
                            </li>
                            <?php endif; ?>
                            <?php endif; ?>
                            <?php if($settings['currency_enable'] == 'yes'): ?>
                                <?php if($settings['currency_type'] == 'custom_link'): ?>
                            <li>
                                <a class="language-dropdown-active">
                            ...
                            <?php elseif($settings['currency_type'] == 'shortcode_cur'): ?>
                            <li><?php echo do_shortcode($settings['shortcode_currency']); ?></li>
                            <?php endif; ?>
                            <?php endif; ?>
                        </ul>
                    </div>
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2 compare_one">
                                <?php  
                                  ...
                                  if(!empty($settings['compare_link']['url'])){
                                      $page_link = $settings['compare_link']['url'];
                                  }
                                  else{ 
                                      $woosc_settings = get_option('woosc_settings'); 
                                      if (is_array($woosc_settings) && isset($woosc_settings['page_id'])) {
                                          $page_id = $woosc_settings['page_id'];
                                          $page_link = get_permalink($page_id); 
                                      }
                                  }
                                ?> 
                                <a href="<?php echo esc_attr($page_link); ?>"  <?php if(!empty($settings['compare_link'])){ echo esc_attr($targe_compare);  echo esc_attr($nofollow_compare); } ?>>
                            ...
                            <?php if(empty($settings['wishlist_link'])): ?>
                                <a>
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap  account-dropdown">
                                    ...
                                    <?php if(!empty($settings['login_text'])): ?>
                                        <li>
                                        <?php if(!empty($settings['login_link']['url'])):  
                                            $lotarget = $settings['login_link']['is_external'] ? ' target="_blank"' : '';
                                            $lofollow = $settings['login_link']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                                                <a href="<?php echo esc_url($settings['login_link']['url']); ?>" 
                                                <?php echo esc_attr($lotarget); ?>
                                                <?php echo esc_attr($lofollow); ?>>
                                        ...
                                        <li>
                                            <?php if(!empty($settings['re_link']['url'])):  
                                            $retarget = $settings['re_link']['is_external'] ? ' target="_blank"' : '';
                                            $refollow = $settings['re_link']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                                                <a href="<?php echo esc_url($settings['re_link']['url']); ?>" 
                                                <?php echo esc_attr($retarget); ?>
                                                <?php echo esc_attr($refollow); ?>>
    ...
    <div class="header-bottom header-bottom-bg-color sticky-bar">
        <div class="auto-container">
            <div class="header-wrap header-space-between position-relative">
                ...
                <?php if($settings['category_enable'] == 'yes' || $settings['hot_deals_enable'] == 'yes'): ?>
                                    ...
                                    <li class="content_cat_list <?php if(!empty($cat_repeater['cat_image']['url'])): ?>cat_image_in <?php endif; ?>">
                                        <a href="<?php echo esc_url($cat_repeater['cat_link']['url']); ?>"
                                            ...
                                            <img src="<?php echo esc_url($cat_repeater['cat_image']['url']); ?>"
                                                alt="<?php echo esc_attr($alt_text); ?>"> <?php endif; ?>
                ...
                <div class="hotline d-flex">
                    <?php if(!empty($settings['toll_free_image']['url'])):
                          $alt_text = 'alt';
                          $image = isset($settings['toll_free_image']['alt']) ? $settings['toll_free_image']['alt'] : '';
                          if(!empty($image)) {
                              $alt_text = $image;
                          }
                        ?>
                    <img src="<?php echo esc_url($settings['toll_free_image']['url']); ?>" alt="<?php echo esc_attr($alt_text); ?>" />
                    <?php else: ?>
