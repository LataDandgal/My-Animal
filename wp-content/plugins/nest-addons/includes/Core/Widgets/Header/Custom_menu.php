...
$this->add_control(
    'menu_margins',
    [ 
        'label' => __( 'Menu Margin', 'nest-addons' ),
        'type' => \Elementor\Controls_Manager::DIMENSIONS,
        'size_units' => [ 'px', '%', 'em' ], 
        'selectors' => [
            '{{WRAPPER}} .main-menu > nav > ul > li  ' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important;',
        ],
    ]
);
...
$this->add_control(
    ...
    [ 
        ...
        'size_units' => [ 'px', '%', 'em' ], 
        'selectors' => [
            '{{WRAPPER}} .main-menu > nav > ul > li > a ' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important;',
        ],
    ]
);
$this->add_control(
...
<div class="cat_menu_box <?php echo esc_attr($settings['menu_styles']); ?> <?php echo esc_attr($settings['list_type']); ?> <?php echo esc_attr($settings['drop_down_alignment']); ?>">
    <ul class="cat_listed">
        <?php foreach($settings['menu_repeater'] as  $key => $menu_repeater): 
            ...
            ?>
        <li
            class="cat_menu_item <?php if($menu_repeater['drop_down_enable'] == 'yes'): 
            ...
            <a class="m_link" href="<?php echo esc_url($menu_repeater['menu_item_link']['url']); ?>"
                <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>>
                <div class="align-items-center">
                    <?php if(!empty($menu_repeater['image']['url'])): 
                         $alt_text = 'alt';
                         $image = isset($menu_repeater['image']['alt']) ? $menu_repeater['image']['alt'] : '';
                         if(!empty($image)) {
                             $alt_text = $image;
                         }
                        ?>
                    <img class="active img-fluid" src="<?php echo esc_url($menu_repeater['image']['url']); ?>"
                        alt="<?php echo esc_attr($alt_text); ?>">
                    <?php endif; ?>
                    <?php echo wp_kses($menu_repeater['menu_item'] , $allowed_tags); ?>
                </div>
                <?php if($menu_repeater['drop_down_enable'] == 'yes'): ?> <i class="fi-rs-angle-down"></i>
                <?php endif; ?>
            </a>
            <?php
