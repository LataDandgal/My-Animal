    ...
    protected function register_controls(){
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'justify' => [
                            'title' => esc_html__( 'Justify', 'nest-addons' ),
                    ...
                    'toggle' => true,
                    'selectors' => [
                        '{{WRAPPER}} .news-flash a ' => 'text-align: {{VALUE}}!important;',
                    ],
                    'condition' => [
                        'menu_types' => 'news'
                    ],
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'toggle' => true,
                    'selectors' => [
                        '{{WRAPPER}} .header-action-2 ' => 'justify-content: {{VALUE}}!important;',
                    ],
                    'condition' => [
                        'menu_types' => ['cart' , 'wishlist' , 'compare' , 'account' ]
                    ],
                ]
            ); 
        ...
        $this->add_group_control(
			...
			[
                'label' => esc_html__( 'Flash Typography', 'nest-addons' ),
				'name' => 'fash_new',
				'selector' => '{{WRAPPER}} .news-flash a',
			]
		);
        $this->add_control(
            'css_hr_msix',
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Search Border Radius', 'nest-addons' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .extra_n_items .search-style-2 form  , {{WRAPPER}} .extra_n_items .search-style-2 form  input[type="search"] ' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important;',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            'searchbtn_border_radius',
            [
                'label' => esc_html__( 'Search Button Border Radius', 'nest-addons' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .dgwt-wcas-search-form .dgwt-wcas-sf-wrapp button.dgwt-wcas-search-submit , {{WRAPPER}} .custom_search .submit ' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important;',
                ],
            ]
        );
        $this->add_control(
...
<div class="header-action-2 compare_one">
    ...
    ?>
        <a href="<?php echo esc_attr($page_link); ?>"
            <?php if(!empty($settings['compare_link'])){ echo esc_attr($targe_compare);  echo esc_attr($nofollow_compare); } ?>>
            ...
            $nofollow_five = $user_repeater['link']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                <li>
                    <a href="<?php echo esc_url($user_repeater['link']['url']); ?>"
                        <?php echo esc_attr($target_five); ?> <?php echo esc_attr($nofollow_five); ?>>
