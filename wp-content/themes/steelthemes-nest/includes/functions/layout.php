    ...
    */
    function nest_get_page_header_image(){   
         global $nest_theme_mod;
            ...
            if((is_page()  || is_singular(array('post' , 'product')) || is_post_type_archive('product') || is_tax() || is_tag() || is_day() || is_year() || is_month()  || is_tax( 'product_cat')  || is_tax('brand') || is_category())){
...
if (!function_exists('nest_column_for_shop_single')):
    function nest_column_for_shop_single(){
