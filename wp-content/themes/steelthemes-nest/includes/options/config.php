...
if(!class_exists('Redux')) {
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Theme Options', 'steelthemes-nest' ),
        'page_title'           => __( 'Theme Options', 'steelthemes-nest' ),
    ...
    if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        $args['intro_text'] = sprintf( __( '', 'steelthemes-nest' ), $v );
    } else {
        $args['intro_text'] = __( '<p>This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.</p>', 'steelthemes-nest' );
    }

    // Add content after the form.
    $args['footer_text'] = __( '<p></p>', 'steelthemes-nest' );
    ...
    require get_template_directory() . '/includes/options/theme-options/sticky-header.php';
    require get_template_directory() . '/includes/options/theme-options/page_header_settings.php';
    require get_template_directory() . '/includes/options/theme-options/breadcrumb-settings.php';
    require get_template_directory() . '/includes/options/theme-options/mobile-menu.php';
    require get_template_directory() . '/includes/options/theme-options/mobile-menu-two.php';
